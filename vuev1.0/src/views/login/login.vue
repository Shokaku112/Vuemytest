<template>
  ...
  <div class="bg" :style="note">
    <div
      style="width: 340px;height: 400px;position: relative;border-radius: 0px;opacity: 100%;background-color: gray;left:70%;top:10%;z-index: 100"
    >
      <div
        style="width: 310px;height: 160px;background: none;left: 10%;margin-left: 15px;text-align: center"
      >
        <img
          src="../../../public/image/3.jpg"
          style="max-width: 75%;margin-top: 15px"
        />
        <p>让创作变得更有趣</p>
      </div>

      <div
        style="width: 300px;height: 150px;background: none;text-align: center;position:relative;left:6%;top:15% "
      >
        <form role="form">
          <div class="form-group">
            ...
            <el-button
              @click="toogleMenu()"
              style="width: 125px;height:40px;margin: 10px;display: inline;margin-top: 20px"
              type="submit"
              class="btn btn-info"
              >登录</el-button
            >
...
export default {
  ...
  data() {
    return {
      note: {
        width: "100%",
        backgroundImage: "url(" + require("../../assets/image/big.jpg") + ")",
  ...
  methods: {
    ...
    toogleMenu() {
      ...
      if (this.Times > 5) {
        ...
        var url =
          "http://192.168.88.107:3000/api/user/login?username=" +
          this.userName +
          "&userpwd=" +
          this.userPwd;
        console.log(url);

<template>
  <div>
    ...
    <div class="nav white">
      <div class="logo">
        <img src="../../../../templater/AmazeUI/images/logo.png" />
      </div>
      <div class="logoBig">
      ...
      <div class="search-bar pr">
        ...
        <form id="app2">
          ...
          <el-button
            type="success"
            style="width: 115px;margin-left: 11px ;height: 46px;"
            ><a
              style="border: 1px; font-size:32px;text-decoration:none;"
              href="http://192.168.88.107:9999/ad.html"
              @click="onItemclick2"
              >搜索</a
            ></el-button
          >
      ...
      <ul
        class="list-group"
        id="searchResult"
        style="padding-left: 165px;position: relative"
      >
        <li
          v-on:mouseenter="changColor($event)"
          v-on:mouseleave="changebackColor($event)"
          v-for="item in searchData"
          class="list-group-item before"
          style="position:relative;z-index:10;width: 533px;height: 20px;padding-bottom: 20px;padding-top: 5px;text-align: left"
          onclick=""
        >
          <a
            href="http://192.168.88.107:9999/ad.html"
            @click="onItemclick(item.proname)"
            >{{ item.proname }}{{ item.proprice }}</a
          >
        </li>
      </ul>
    </div>
    ...
    <div style="width: 100%;height: 40px;">
      <a class="alabel" href="#" style="padding: 5px"
        ><img
          style="width:100px;height: 30px"
          src="../../assets/image/TB1ztBlaMMPMeJjy1XbXXcwxVXa-200-60.png"
      /></a>
      <a class="alabel" href="#" style="padding: 5px"
        ><img
          style="width:100px;height: 30px"
          src="../../assets/image/TB1t5ObaBxRMKJjy0FdXXaifFXa-200-60.png"
      /></a>
        ...
        <el-carousel style="width: 100%" height="500px">
          <el-carousel-item>
            <img
              ...
              src="../../assets/image/TB1FNXGvHr1gK0jSZR0SuvP8XXa.jpg"
            />
          </el-carousel-item>
          <el-carousel-item>
            <img
          ...
          <el-carousel-item>
            <img
              style="width: 100%;height: 100%"
              src="../../assets/image/TB19tklmxD1gK0jSZFKSuwJrVXa.jpg"
            />
          </el-carousel-item>
        </el-carousel>
      </div>
    ...
    <div class="am-container">
      ...
      <div class="am-g am-g-fixed sale">
        <div class="am-u-sm-3 sale-item">
          <div class="s-img">
            <a href="# "
              ><img src="../../../../templater/AmazeUI/images/sale3.jpg"
            /></a>
          </div>
          <div class="s-info">
        ...
        <div class="am-u-sm-3 sale-item">
          <div class="s-img">
            <a href="# "
              ><img src="../../../../templater/AmazeUI/images/sale2.jpg"
            /></a>
          </div>
          <div class="s-info">
            <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
        ...
        <div class="am-u-sm-3 sale-item">
          <div class="s-img">
            <a href="# "
              ><img src="../../../../templater/AmazeUI/images/sale1.jpg"
            /></a>
          </div>
          <div class="s-info">
            <a href="#"><p class="s-title">ZEK 原味海苔</p></a>
    ...
    <div class="shopTitle ">
      ...
      <div class="today-brands " style="right:0px ;top:13px;">
        <a href="# ">桂花糕</a>| <a href="# ">奶皮酥</a>|
        <a href="# ">栗子糕 </a>| <a href="# ">马卡龙</a>|
        <a href="# ">铜锣烧</a>|
        <a href="# ">豌豆黄</a>
      </div>
    </div>
    <div class="am-g am-g-fixed floodSix ">
      <div class="am-u-sm-5 am-u-md-3 text-one list">
        <div class="word">
          <a class="outer" href="#"
            ><span class="inner"><b class="text">核桃</b></span></a
          >
          <a class="outer" href="#"
            ><span class="inner"><b class="text">核桃</b></span></a
          >
      ...
      <div class="am-u-sm-7 am-u-md-5 am-u-lg-2 text-two big">
        ...
        <a href="# "
          ><img src="../../../../templater/AmazeUI/images/act1.png"
        /></a>
      </div>
      ...
      <li>
        <div class="am-u-md-2 am-u-lg-2 text-three">
          ...
          <a href="# "
            ><img src="../../../../templater/AmazeUI/images/1.jpg"
          /></a>
        </div>
      </li>
      <li>
        <div class="am-u-md-2 am-u-lg-2 text-three sug">
          ...
          <a href="# "
            ><img src="../../../../templater/AmazeUI/images/2.jpg"
          /></a>
        </div>
      </li>
      <li>
      ...
      <li>
        <div class="am-u-sm-4 am-u-md-2 am-u-lg-2 text-six">
          ...
          <a href="# "
            ><img src="../../../../templater/AmazeUI/images/3.jpg"
          /></a>
        </div>
      </li>
      <li>
        <div class="am-u-sm-4 am-u-md-2 am-u-lg-4 text-six">
          ...
          <a href="# "
            ><img src="../../../../templater/AmazeUI/images/4.jpg"
          /></a>
        </div>
      </li>
    </div>
    ...
    <div class="footer ">
      ...
      <div class="footer-bd ">
        <p>
          <a href="# " style="margin: 0px 5px 0px 5px;">关于我们</a>
          <a href="# " style="margin: 0px 5px 0px 5px;">合作伙伴</a>
          <a href="# " style="margin: 0px 5px 0px 5px;">联系我们</a>
          <a href="# " style="margin: 0px 5px 0px 5px;">网站地图</a>
          <em>© 2015-2025 TEST.com 版权所有</em>
        </p>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    getserachData() {
      var that = this;
      var url =
        "http://192.168.88.107:3000/api/user/search?hotword=" + hotsport;

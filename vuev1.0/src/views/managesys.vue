<template>
            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button @click="formget2($event)" type="text" size="small">编辑</el-button>
                        <el-button @click="formget($event)" type="text" size="small">删除</el-button>
                        <!--删除对话框-->
                        <el-dialog
                                title="提示"
    ...
    <el-button type="primary" @click="testDel($event)">确 定</el-button>
  </span>
                        </el-dialog>
                        <!--编辑对话框-->
                        <el-dialog
    ...
    export default {
        ...
        methods: {
            ...
            formget2(e){
                ...
                var number=e.currentTarget.parentNode.parentNode.parentNode.childNodes[3].lastChild.textContent;
                var total=e.currentTarget.parentNode.parentNode.parentNode.childNodes[4].lastChild.textContent;
                var address=e.currentTarget.parentNode.parentNode.parentNode.childNodes[5].lastChild.textContent;
                var status=e.currentTarget.parentNode.parentNode.parentNode.childNodes[6].lastChild.textContent;

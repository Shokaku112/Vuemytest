    ...
    <div>
        <nav class="navbar navbar-inverse" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header" style="float: right;width: 284px;height: 53px">
                    <li class="dropdown"  style="float: left;padding: 15px">
                        <a id="username" href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="padding: 15px">欢迎你！，{{userinfo.username}}<span class="caret"></span></a>
                        <ul id="usernav"  class="dropdown-menu">
                            <li id="head1" :class=li1 @click="pushinfo()"><a href="#">个人信息</a></li>
                            <li @click="logout()" id="head2" :class=li1><a href="#">登出</a></li>

                        </ul>
                    </li>
                    <a style="float: right;margin-top: 5px" href="#"><img style="width: 48px;height: 48px;"  class="img-circle" :src="require('../../'+userinfo.src)"></a>
